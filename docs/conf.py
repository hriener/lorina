...
# -*- coding: utf-8 -*-
#
# lorina documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'lorina.tex', 'lorina Documentation',
     'Heinz Riener', 'manual'),
]
...
man_pages = [
    (master_doc, 'lorina', 'lorina Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'lorina', 'lorina Documentation',
     author, 'lorina', 'One line description of project.',
     'Miscellaneous'),
]
...
breathe_projects = {"lorina": "doxyxml/xml"}
breathe_default_project = "lorina"
